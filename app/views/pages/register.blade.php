				...
				<form accept-charset="UTF-8" action="{{URL::to('register')}}" class="simple_form analytics-event" data-event-name="regular email log in attempt" id="new_user_session" method="post">
					<div class="login-block" >
						...
						<div class="form-fields-wrapper">
							...
							<div class="pad-top">
								<div class="form-control-wrapper" >
									<input name = "password_confirmation" type="password" class="form-control" required placeholder = 'Re-enter Password'>
									
								</div>			
							</div>
							<div class="pad-top">
								<div class="form-control-wrapper" >
									<input name = "phone_number" type="text" class="form-control" required placeholder = 'Phone number'>
