	...
	<div class="container">
			...
			<div class="col-md-2">
				<div class="list-group">
					  ...
					  <a href="myjobs" class="list-group-item">Ongoing Jobs</a>
					  <a href="myjobs" class="list-group-item">Cancelled Jobs</a>
					  <a href="myjobs" class="list-group-item">Pending reviews</a>
					  <a href="myjobs" class="list-group-item">Completed Jobs</a>
